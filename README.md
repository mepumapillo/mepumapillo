...
I help entrepreneurs, marketing managers and agencies implement **digital analytics systems** to scale with reliable data.

> *"Datos confiables. Decisiones inteligentes. Crecimiento real."*

- 🔍 Specialized in **Google Analytics 4**, **Google Ads** & **Meta Ads** tracking
- 🏗️ I build end-to-end analytics infrastructure tailored to each business
- 📈 I turn scattered data into actionable insights
- 🌎 Based in **Peru** | Working globally
...
![Cloud Scheduler](https://img.shields.io/badge/Cloud_Scheduler-4285F4?style=for-the-badge&logo=google-cloud&logoColor=white)
...
- ✅ **GA4 Implementation** — Custom events, ecommerce tracking, conversion setup
- ✅ **Server-Side Tracking** — Meta Ads API, accurate attribution beyond iOS limitations
- ✅ **Data Pipelines** — BigQuery + Cloud Run automations
- ✅ **Dashboards** — Looker Studio & Power BI unified reporting
- ✅ **AI Automation** — n8n & Gemini AI for data workflows

---

## 📬 Let's connect!

💼 [miguelanalytics.dev](https://miguelanalytics.dev) — Book a free 30-min session  
📺 [YouTube @miguel.analytics](https://youtube.com/@miguel.analytics) — Tutorials & case studies  
🎵 [TikTok @miguel.analytics](https://tiktok.com/@miguel.analytics) — Quick tips & trends  
📷 [Instagram @miguelanalytics](https://instagram.com/miguelanalytics) — Behind the scenes
